  ...
  return (
    <div >
        ...
        <div className={style.card}>
          ...
          <div className={style.face + " " + style.back}>
            <h3>
              ...
              protección total para tus compras y recibir el dinero de vuelta si
      ...
      <div className={style.conteiner}>
        <div className={style.card}>
          <div className={style.face + " " + style.front}>
            <h3>¿Qué hago si mi producto no está cubierto por la garantía?</h3>
          </div>
          <div className={style.face + " " + style.back}>
            <h3>
              Si su producto no está cubierto por la garantía, le recomendamos
              que contacte con nuestro servicio al cliente para obtener
              asesoramiento sobre los pasos a seguir para solucionar el problem
            </h3>
          </div>
        </div>
      </div>
      <div className={style.conteiner}>
        <div className={style.card}>
          ...
          <div className={style.face + " " + style.back}>
            <h3>
              Aceptamos devoluciones dentro de los 30 días a partir de la fecha
              de entrega. Los productos devueltos deben estar sin usar y en
              buenas condiciones para que podamos aceptarlos.
            </h3>
          </div>
        </div>
      </div>
      <div className={style.conteiner}>
        <div className={style.card}>
          ...
          <div className={style.face + " " + style.back}>
            <h3>
              Para realizar una devolución, debe contactar con nuestro servicio
              al cliente enviando un correo electrónico a contacto@tienda.com y
      ...
      <div className={style.conteiner}>
        <div className={style.card}>
          ...
          <div className={style.face + " " + style.back}>
            <h3>
              Si el producto fue entregado dañado, le recomendamos que contacte
              con nuestro servicio al cliente para solicitar un reemplazo.
              También le reembolsaremos el dinero si el producto no se puede
